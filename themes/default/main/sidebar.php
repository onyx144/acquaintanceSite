	...
	<ul class="home_usr_link">
		...
		<li class="vis <?php if($data['name'] == 'blog'){ echo 'active';}?>">
			<a href="<?php echo $site_url;?>/blog" data-ajax="/blog">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M20 3H4C2.89 3 2 3.89 2 5V19C2 20.11 2.89 21 4 21H20C21.11 21 22 20.11 22 19V5C22 3.89 21.11 3 20 3M5 7H10V13H5V7M19 17H5V15H19V17M19 13H12V11H19V13M19 9H12V7H19V9Z"></path></svg> <?php echo __( 'Blog' );?>
			</a>
		</li>
        ...
        <li class="pli <?php if($data['name'] == 'stories'){ echo 'active';}?>">
			<a href="<?php echo $site_url;?>/stories" data-ajax="/stories">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M18,22A2,2 0 0,0 20,20V4C20,2.89 19.1,2 18,2H12V9L9.5,7.5L7,9V2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18Z"></path></svg> <?php echo __( 'Success stories' );?>
			</a>
		</li>
		<?php } ?>
