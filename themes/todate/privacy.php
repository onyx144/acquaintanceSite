	...
	<div class="container dt_terms">
		<div class="row">
			<div class="col s12 m4 l3">
				<div class="dt_terms_sidebar">
					<ul>
						...
						<li class="active"><a href="<?php echo $site_url;?>/privacy" data-ajax="/privacy"><?php echo __( 'Privacy Policy' );?></a></li>
			...
			<div class="col s12 m8 l9">
				<h2 class="bold"><?php echo __( 'Privacy Policy' );?></h2>
				<div class="dt_terms_content_body">
					<?php echo __('privacy_policy_page'); ?>
				</div>
			</div>
		</div>
	</div>
