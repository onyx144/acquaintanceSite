...
<div class="row to_sett_row">
	...
	<div class="col m12 l8">
        <form method="POST" action="/profile/save_password_setting" class="dt_settings">
			<h2 class="user_sttng_panel_hd"><?php echo __( 'account_password_settings' );?></h2>
...
<!--                <input id="c_pass" name="c_pass" type="hidden">-->
            <?php } ?>
			<div class="to_mat_input">
				<input name="n_pass" id="n_pass" class="browser-default" type="password" placeholder="<?php echo __( 'New Password' );?>">
				<label for="n_pass"><?php echo __( 'New Password' );?></label>
			</div>
			<div class="to_mat_input">
				<input name="cn_pass" id="cn_pass" class="browser-default" type="password" placeholder="<?php echo __( 'Confirm New Password' );?>">
				<label for="cn_pass"><?php echo __( 'Confirm New Password' );?></label>
			</div>
            <div class="dt_sett_footer">
                <button class="btn btn-large bold btn_primary btn_round" type="submit" name="action"><span><?php echo __( 'Change' );?></span> <svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z"></path></svg></button>
            </div>
