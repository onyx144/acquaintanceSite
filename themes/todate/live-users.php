...
<div class="container page-margin">
	...
	<div class="dt_home_rand_user">
		...
		<?php if(!empty($data['live_users_html'])){ ?>
			<a href="javascript:void(0);" id="btn_load_more_live_users" data-lang-nomore="<?php echo __('No more users to show.');?>" data-ajax-post="/loadmore/LoadLiveUsers" data-ajax-params="page=2" data-ajax-callback="callback_load_more_live_users" class="load_more"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path></svg></span> <?php echo __('Load more...');?></a>
		<?php }?>
	</div>
</div>
