...
<div class="video-con wow_go_live_cont">
    <div class="container">
		...
		<div class="valign-wrapper btn-start-end-prnt">
			<button class="btn btn-start-end start_vdo_call wow_go_live_btn" id="publishBtn" title="<?php echo __('Go Live'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M17,14.5V11A1,1 0 0,0 16,10H4A1,1 0 0,0 3,11V21A1,1 0 0,0 4,22H16A1,1 0 0,0 17,21V17.5L21,21.5V10.5M3,3.86L4.4,5.24C7.5,2.19 12.5,2.19 15.6,5.24L17,3.86C13.14,0.05 6.87,0.05 3,3.86M5.8,6.62L7.2,8C8.75,6.5 11.25,6.5 12.8,8L14.2,6.62C11.88,4.34 8.12,4.34 5.8,6.62Z" /></svg></button>
			<a class="btn btn-start-end end_vdo_call wow_end_live_btn white red-text hide" href="<?php echo($site_url) ?>" onclick="DeleteLive()" title="<?php echo  __('End Live'); ?>">
