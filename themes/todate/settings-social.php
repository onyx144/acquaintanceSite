...
<div class="row to_sett_row">
	...
	<div class="col m12 l8">
        <form method="post" action="/profile/save_social_setting" class="dt_settings">
			<h2 class="user_sttng_panel_hd"><?php echo __( 'Social Links' );?></h2>
            ...
            <div class="row">
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="facebook" id="facebook" class="browser-default" type="text" placeholder="<?php echo __( 'Facebook' );?>" value="<?php echo $user->facebook;?>" autofocus>
						<label for="facebook"><?php echo __( 'Facebook' );?></label>
					</div>
                </div>
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="twitter" id="twitter" class="browser-default" type="text" placeholder="<?php echo __( 'Twitter' );?>" value="<?php echo $user->twitter;?>">
            ...
            <div class="row">
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="google" id="google" class="browser-default" type="text" placeholder="<?php echo __( 'VK' );?>" value="<?php echo $user->google;?>">
						<label for="google"><?php echo __( 'VK' );?></label>
					</div>
                </div>
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="instagram" id="instagram" class="browser-default" type="text" placeholder="<?php echo __( 'instagram' );?>" value="<?php echo $user->instagram;?>">
            ...
            <div class="row">
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="linkedin" id="linkedin" class="browser-default" type="text" placeholder="<?php echo __( 'LinkedIn' );?>" value="<?php echo $user->linkedin;?>">
						<label for="linkedin"><?php echo __( 'LinkedIn' );?></label>
					</div>
                </div>
                <div class="col m6 s12">
					<div class="to_mat_input">
						<input name="website" id="website" class="browser-default" type="text" placeholder="<?php echo __( 'Website' );?>" value="<?php echo $user->website;?>">
