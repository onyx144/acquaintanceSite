				...
				<div class="slider-ctr">
					<div class="slider">
						...
						<?php if ($config->verification_on_signup == 1) { ?>
                            <form class="slider-form slider-one first_slider <?php if ($step != 0) { ?> hide <?php } ?>" id="verification_on_signup" style="padding: 20px 5px;">
                                ...
                                <div class="step_footer verification_requests_footer <?php echo $class;?>">
									<button class="waves-effect waves-light btn btn_primary bold first next" onclick="GoToNextStep('first_slider',1)"><span id="nexttext"><?php echo __( 'Next' );?></span><svg viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg" width="18" height="18"><path fill="currentColor" d="M18.6 6.9v-.5l-6-6c-.3-.3-.9-.3-1.2 0-.3.3-.3.9 0 1.2l5 5H1c-.5 0-.9.4-.9.9s.4.8.9.8h14.4l-4 4.1c-.3.3-.3.9 0 1.2.2.2.4.2.6.2.2 0 .4-.1.6-.2l5.2-5.2h.2c.5 0 .8-.4.8-.8 0-.3 0-.5-.2-.7z"></path></svg></button>
                                </div>
                            </form>
						<?php }?>
						...
						<form class="slider-form slider-two <?php if ($step != 2) { ?> hide <?php } ?> third_slider">
							...
							<div class="row r_margin">
								<?php if( $config->disable_phone_field == 'on' ){ ?>
									<div class="col s6">
										<div class="to_mat_input">
											<input id="mobile" type="text" data-errmsg="<?php echo __( 'Your phone number is required.');?>" class="browser-default" placeholder="<?php echo __('Phone number, e.g +90..');?>" <?php if($config->sms_or_email == 'sms'){?> data-validation-type="sms" required<?php }else{?> data-validation-type="mail" <?php } ?> data-p-verified="yes">
									...
									<div class="enter_otp_email">
										...
										<div id="otp_outer">
											<div id="otp_inner">
												...
												<a href="<?php echo $site_url;?>/steps" onclick="resendCode(this)"><?php echo __( 'Resend' );?></a>
											</div>
										</div>
									</div>
									<!-- End Email -->
