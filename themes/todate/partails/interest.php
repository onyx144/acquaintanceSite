	...
	<div class="to_small_usr">
		<div class="card-image">
			...
			<?php if( (int)$row->id !== (int)auth()->id ){ ?>
                <button id="like_btn<?php echo $row->id?>" class="btn to_small_not like" data-ajax-post="/useractions/like" data-ajax-params="userid=<?php echo $row->id?>&username=<?php echo $row->username?>" data-ajax-callback="callback_like_interest">
