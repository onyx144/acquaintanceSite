...
<div class="row to_sett_row">
	...
	<div class="col m12 l8">
        <form method="post" action="/profile/save_email_setting" class="dt_settings">
			<h2 class="user_sttng_panel_hd"><?php echo __( 'Emails' );?> <?php echo __( 'Settings' );?></h2>
            ...
            <div class="row">
				...
				<div class="col s12 l8">
                    <p class="to_mat_input_switch switch no_margin_top">
                        <label>
