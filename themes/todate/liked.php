...
<div class="container page-margin">
	...
	<div class="valign-wrapper to_page_title">
		<h3 class="valign-wrapper"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M13 14.062V22H4a8 8 0 0 1 9-7.938zM12 13c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6zm5.793 6.914l3.535-3.535 1.415 1.414-4.95 4.95-3.536-3.536 1.415-1.414 2.12 2.121z" fill="currentColor"></path></svg></span> <?php echo __( 'People i liked' );?></h3>
	</div>
	<div class="dt_home_rand_user">
		...
		<?php if(!empty($data['liked'])){ ?>
			<a href="javascript:void(0);" id="btn_load_more_liked_users" data-lang-nomore="<?php echo __('No more users to show.');?>" data-ajax-post="/loadmore/liked_users" data-ajax-params="page=2" data-ajax-callback="callback_load_more_liked_users" class="load_more"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"></path></svg></span> <?php echo __('Load more...');?></a>
		<?php }?>
	</div>
</div>