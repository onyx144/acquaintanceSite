    ...
    <div class="row r_margin">
        ...
        <div class="col l8">
			<div class="valign-wrapper to_page_title">
				<h3 class="valign-wrapper"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M7 3H5V9H7V3M19 3H17V13H19V3M3 13H5V21H7V13H9V11H3V13M15 7H13V3H11V7H9V9H15V7M11 21H13V11H11V21M15 15V17H17V21H19V17H21V15H15Z" fill="currentColor"></path></svg></span> App Permissions</h3>
